...
//в≥д р≥зних елемент≥в першого стовпц€ матриц≥. 
...
////////////////////////////////////////////////////////
int Matr::ScalarMult( ) const {			//знаходить скал€рний добуток 
	int res=0, d;
	cout<<"\nResidue of division: \n";
	for ( ui i=0; i<N; i++ ){			//остача в≥д д≥ленн€ елемент≥в першого стовпц€ на розм≥рн≥сть матриц≥
		d=m[i][0] % N;
		res+= m[0][i]*d;
		cout<<d<<" ";
	}
