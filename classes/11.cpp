...
//від різних елементів першого стовпця матриці. 
...
////////////////////////////////////////////////////////
int Matr::ScalarMult( ) const {			//знаходить скалярний добуток 
	int res=0, d;
	cout<<"\nResidue of division: \n";
	for ( ui i=0; i<N; i++ ){			//остача від ділення елементів першого стовпця на розмірність матриці
		d=m[i][0] % N;
		res+= m[0][i]*d;
		cout<<d<<" ";
	}
